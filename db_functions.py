...
def add_curent_results(data, time):
    """
    ...
    for item in data:
        ...
        id_user = id_user[0][0]
        params = [id_user, time, item["rank"]] + item["score"]
        cursor.execute("INSERT INTO Scores (ID_user, time, rank, task_1, task_2, task_3, task_4, task_5, task_6, task_7, task_8) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", params)
    connect.commit()
